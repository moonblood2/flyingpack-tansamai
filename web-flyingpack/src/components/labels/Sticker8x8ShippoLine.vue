<template>
  <div class="sticker-messenger">
    <div>
      ...
      />
      <img
        :src="require('@/assets/logo/courier/line_messager.png')"
        height="50"
        width="100"
      />
      <img
        :src="require('@/assets/logo/courier/grab_express.png')"
        height="50"
        width="100"
      />
...
export default {
  ...
  mounted() {
    JsBarcode(`#${this.id}`, this.parcel.referenceNo, {
      format: "CODE128",
      width: 10,
      height: 100,
      margin: 0,
...
.sticker-messenger .sorting .b1 {
  width: 60%;
  font-size: 14px;
  text-align: center;
}

.sticker-messenger .sorting .b2 {
  width: 40%;
  color: white;
  font-size: 25px;
  font-weight: bold;
...
.sticker-messenger .destination .first-line {
  font-size: 13px;
}

.sticker-messenger .other {
  display: flex;
  height: 50px;
  border: 1px solid #666;
}

.sticker-messenger .other .item-list {
  width: 50%;
  font-size: 9px;
  border-right: 1px solid #666;
}

.sticker-messenger .other .item-list .item {
}

.sticker-messenger .other .cod {
  width: 50%;
  margin: auto;
  text-align: center;
  font-size: 14px;
